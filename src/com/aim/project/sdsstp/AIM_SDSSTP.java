...
public class AIM_SDSSTP extends ProblemDomain implements Visualisable {
	...
	public double applyHeuristic(int hIndex, int currentIndex, int candidateIndex) {
		...
		int rep[] = getSolution(currentIndex).getSolutionRepresentation().getSolutionRepresentation();
		for(int j = 0; j<rep.length; j++) {
			System.out.print(rep[j] + "  ");
		}
		System.out.print("\n");
		System.out.print("candidatesolution: ");
		int rep2[] = getSolution(candidateIndex).getSolutionRepresentation().getSolutionRepresentation();
		for(int j = 0; j<rep.length; j++) {
			System.out.print(rep2[j] + "  ");
		}
		System.out.print("\n");
		System.out.print("bestsolution: ");
		int rep1[] = bestSolution.getSolutionRepresentation().getSolutionRepresentation();
		for(int j = 0; j<rep1.length; j++) {
			System.out.print(rep1[j] + "  ");
		}
		System.out.print("\n");*/
	...
	public double applyHeuristic(int hIndex, int parent1Index, int parent2Index, int candidateIndex) {
		...
		/*System.out.print("parent1solution: ");
		int rep[] = getSolution(parent1Index).getSolutionRepresentation().getSolutionRepresentation();
		for(int j = 0; j<rep.length; j++) {
			System.out.print(rep[j] + "  ");
		}
		System.out.print("\n");
